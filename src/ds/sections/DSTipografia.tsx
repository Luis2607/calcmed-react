    ...
    <div>
        ...
        <div className="flex gap-8 mb-6">
          <div className="flex-1">
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li className="flex gap-2 items-start mb-2"><i className="ph ph-check-circle" style={{ color: 'var(--success)', flexShrink: 0, marginTop: 2 }} /><span className="t-corpo-2">Exibir doses e resultados numéricos com t-dose-valor (mínimo 20px obrigatório)</span></li>
              <li className="flex gap-2 items-start mb-2"><i className="ph ph-check-circle" style={{ color: 'var(--success)', flexShrink: 0, marginTop: 2 }} /><span className="t-corpo-2">Escrever parágrafos e descrições com t-corpo ou t-corpo-2</span></li>
              <li className="flex gap-2 items-start mb-2"><i className="ph ph-check-circle" style={{ color: 'var(--success)', flexShrink: 0, marginTop: 2 }} /><span className="t-corpo-2">Exibir valores monetários ou números tabulares com JetBrains Mono (t-valor-mono)</span></li>
            </ul>
          </div>
          <div className="flex-1">
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              ...
              <li className="flex gap-2 items-start mb-2"><i className="ph ph-x-circle" style={{ color: 'var(--danger)', flexShrink: 0, marginTop: 2 }} /><span className="t-corpo-2">Usar t-corpo para títulos e cabeçalhos. Use t-titulo-pagina ou t-titulo-secao</span></li>
      ...
      <div className="ds-subsection">
        ...
        <p className="t-corpo-2 text-fg-2 mb-4">
          ...
          Isso garante consistência visual e facilita ajustes globais.
        </p>
