  ...
  return (
    <div>
      ...
      <p className="ds-section-desc">
        ...
        segura ou exceder um limite crítico.
      </p>
      <p className="ds-section-desc">
        O sistema possui 5 níveis hierárquicos, cada um com cor,
        ...
        <div className="flex gap-8 mb-6">
          <div className="flex-1">
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li className="flex gap-2 items-start mb-2"><i className="ph ph-check-circle" style={{ color: 'var(--success)', flexShrink: 0, marginTop: 2 }} /><span className="t-corpo-2">Exibir dose ou valor calculado. Use SEMPRE nível 2 (result) como protagonista visual</span></li>
              <li className="flex gap-2 items-start mb-2"><i className="ph ph-check-circle" style={{ color: 'var(--success)', flexShrink: 0, marginTop: 2 }} /><span className="t-corpo-2">Dose máxima foi excedida. Use nível 3 (critical) SOMENTE neste caso</span></li>
              <li className="flex gap-2 items-start mb-2"><i className="ph ph-check-circle" style={{ color: 'var(--success)', flexShrink: 0, marginTop: 2 }} /><span className="t-corpo-2">Incluir observações clínicas ou ajustes necessários. Use nível 4 (warning/âmbar)</span></li>
            </ul>
          </div>
          <div className="flex-1">
            <div className="t-texto-badge text-danger mb-3" style={{ textTransform: 'uppercase', letterSpacing: 1 }}>Não use quando</div>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li className="flex gap-2 items-start mb-2"><i className="ph ph-x-circle" style={{ color: 'var(--danger)', flexShrink: 0, marginTop: 2 }} /><span className="t-corpo-2">Usar nível 3 (vermelho) para avisos genéricos. Avisos são nível 4 (âmbar)</span></li>
              <li className="flex gap-2 items-start mb-2"><i className="ph ph-x-circle" style={{ color: 'var(--danger)', flexShrink: 0, marginTop: 2 }} /><span className="t-corpo-2">Exibir resultado de dose sem nível 2. O verde é obrigatório para doses calculadas</span></li>
              <li className="flex gap-2 items-start mb-2"><i className="ph ph-x-circle" style={{ color: 'var(--danger)', flexShrink: 0, marginTop: 2 }} /><span className="t-corpo-2">Omitir referência bibliográfica (nível 5). Todo cálculo precisa de fonte científica</span></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="ds-subsection">
        ...
        <p className="ds-subsection-desc">
          ...
          observação clínica (âmbar) e rodapé/disclaimer (cinza discreto).
        </p>
        <p className="ds-subsection-desc">
          Cada nível tem um papel comunicacional único e insubstituível.
        </p>
        <DSPanel>
      ...
      <div className="ds-subsection">
        ...
        <p className="ds-subsection-desc">
          ...
          de operação, erros de rede, avisos de manutenção.
          Usam as mesmas cores semânticas dos alertas clínicos mas com layout mais compacto e sem ícone obrigatório.
        </p>
        <DSPanel>
      ...
      <div className="ds-subsection">
        <h3>Boas Práticas</h3>
        <p className="ds-subsection-desc">A cor errada em um alerta pode levar a uma dose perigosa. Estas regras são inegociáveis.</p>
