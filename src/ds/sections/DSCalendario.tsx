  ...
  return (
    <div>
      ...
      <p className="ds-section-desc">
        Sistema de calendario para gerenciar plantoes. O medico visualiza sua escala mensal, com dots coloridos
        indicando diferentes hospitais. Simplicidade e essencial — o medico usa no corredor entre atendimentos.
      </p>
        ...
        <DSPanel>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div className="shift-card">
              ...
              <i className="ph ph-caret-right" style={{ color: 'var(--fg-3)' }} />
            </div>
            <div className="shift-card">
      ...
      <div className="ds-subsection">
        ...
        <DSPanel>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <span style={{ font: "400 14px 'Inter'", color: 'var(--fg-2)' }}>
      ...
      <div className="ds-subsection">
        ...
        <table className="ds-token-table">
          ...
          <tbody>
            {[
              { cls: '.calendar-nav', desc: 'Navegacao de mes: flex, space-between' },
              { cls: '.calendar-grid', desc: 'Grid 7 colunas para dias do mes' },
              { cls: '.day-header', desc: 'Cabecalho dos dias: font 600, uppercase, fg-3' },
              { cls: '.day-cell', desc: 'Celula do dia: flex column, center, min-h 48px' },
              { cls: '.day-cell.today', desc: 'Dia atual: fundo primary, texto on, circulo' },
              { cls: '.day-cell.other-month', desc: 'Dia de outro mes: cor fg-3, opacidade reduzida' },
              { cls: '.day-dot', desc: 'Indicador de plantao: 6px, circulo colorido' },
              { cls: '.calendar-legend', desc: 'Legenda: flex wrap, gap 16px' },
              { cls: '.legend-item', desc: 'Item: flex, gap 8px, align center' },
              { cls: '.legend-dot', desc: 'Dot colorido: 10px, circulo' },
              { cls: '.shift-card', desc: 'Card de plantao: flex, radius xl, borda, padding' },
              { cls: '.fab', desc: 'Botao flutuante: 56px, circulo, fundo primary, sombra' },
            ].map(r => (
              <tr key={r.cls}>
